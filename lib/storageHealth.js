...
function getStorageHealth(db) {
  ...
  // Still count broken /uploads refs for API diagnostics, but do not banner them —
  // Joyce is re-uploading blog/shop images; the old "before persistent storage" reminder is done.
