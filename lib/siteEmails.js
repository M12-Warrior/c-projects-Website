...
const SUBJECTS = {
  ...
  CERTIFICATE: 'Mile 12 Warrior — Course Certificate Request',
...
function normalizeCategory(raw) {
  ...
  if (v === 'certificate' || v === 'certificate-request' || v === 'certificate_request') return 'certificate';
