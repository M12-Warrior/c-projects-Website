...
function paymentConfigPayload() {
  ...
  return {
    ...
    pauseReason: paused
      ? 'Checkout is paused while we finish Stripe go-live. Until then, all digital training stays free. New Driver Packet, roadmap checklists, and the Wellness Journal stay free forever.'
      : null
  };
}
