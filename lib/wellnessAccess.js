...
function userHasWellnessJournalAccess(userId) {
  // Wellness Journal is free forever: guests print/download; any signed-in user
  // gets My Journal online. Paid subscription is not required.
  return !!userId;
}
